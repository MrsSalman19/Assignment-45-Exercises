//  ----------------------------------------- Question no 16 ----------------------------
console.log("\n ---------------------------- Question no 16  ----------------------------\n");
let guestList = ["Rani", "Insha", "Afrin", "Umaima"];
...
//  -------------------------------- Question no 18 ----------------------------
console.log("\n -------------------- Question no 18  ---------------------\n");
let countriesToVisit = ["makkatul mukarrama", "China", "Brazil", "Denmark", "Argentina"];
...
//  ---------------------------------------  Question no 19   -----------------------------
console.log("\n ---------------------------- Question no 19 ----------------------------\n");
let guestList1 = ["Rani", "Insha", "Afrin", "Umaima"];
let lengthOfGuest = guestList1.length;
console.log(`We invited total no of guests= ${lengthOfGuest}`);
//  --------------------------------------   Question no 20  ------------------------------
console.log("\n ---------------------------- Question no 20  ----------------------------\n");
let programinglanguage = ["javascript", "typescript", "PHP", "Python"];
