...
let userNames = ["Hassan", "Adil", "Maida", "Rijja ", "Admin"];
userNames = [];
...
let current_users = ["Mahjabeen", "Faiza", "Rameez", "Jibran", "Shaheen"];
let new_users = ["Qamar", "Mahjabeen", "Khadija", "Mahtab", "Jibran"];
...
let pizza = ["pepperoni ", "fajita", "veggie", "chicken tikka"];
